        ...
        <div class="form-horizontal">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title"><strong>Slider Ekleme</strong></h3>
            </div>
              ...
              <div class="panel-body">    
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-xs-12">                                            
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="slider_ad" />
                    </div>                                            
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-xs-12">                                            
                    <div class="input-group">
                      <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                      <input type="text" class="form-control" name="slider_sira"/>
                    </div>                                            
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-xs-12">                                                                                                                             
                    <input type="checkbox" class="icheckbox" name="slider_durum"/> 
                  </div>
                </div>
              </div>                                                                                 
              <div class="panel-footer">   
               <button type="submit" name="slider-ekle" class="btn btn-primary pull-right">Ekle</button>
             </div>
           </form>
         </div>
       </div>
